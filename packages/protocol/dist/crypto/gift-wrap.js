 ...
 */
export async function buildGiftWrap(rumorKind, rumorContent, senderPrivKeyHex, senderPubKeyHex, recipientPubKeyHex) {
    ...
    const sealContent = nip44Encrypt(JSON.stringify(rumor), senderPrivKeyHex, recipientPubKeyHex);
    ...
    const wrapContent = nip44Encrypt(JSON.stringify(seal), wrapperKeypair.privateKey, recipientPubKeyHex);
 ...
 */
export async function buildServiceResponseGiftWrap(rumorKind, responseContent, servicePrivKeyHex, servicePubKeyHex, userPubKeyHex) {
    return buildGiftWrap(rumorKind, responseContent, servicePrivKeyHex, servicePubKeyHex, userPubKeyHex);
}
//# sourceMappingURL=gift-wrap.js.map